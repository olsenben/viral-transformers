...
if __name__=="__main__":
    ...
    BATCH_SIZE = 8
    PATIENCE = 5
    CHECKPOINT_PATH = (os.getcwd(),'models',"best_model.pt")
    ...
    for epoch in range(EPOCHS):
            model.train()
            total_loss = 0
            for batch in tqdm(train_loader, desc=f"Epocj {epoch +1}/{EPOCHS}"):
            ...
            print(f"[Epoch {epoch +1 }] Train MSE: {avg_train_loss:.4f} | Val MSE: {val_mse:.4f} | r: {val_rs:.4f}")
